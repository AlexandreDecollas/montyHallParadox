...
You have now a new choice : keep the initial door, or change and take the one the presenter didn't open. 

What would you choose?

This is a proba problem where the answered seemed very counter-intuitive, pushing me to do this experiment to verify it.
...
So, we can run the program who do this process exactly 1000000 time, and we actually get this result.
